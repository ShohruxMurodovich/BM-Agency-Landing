...
const services = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        subtitle: 'Интеграции',
        description: 'Настраиваем обмен данными между маркетплейсами, CRM, складами и другими системами. Автоматизация процессов снижает количество ошибок и ускоряет работу компании.'
      },
      {
